<div class="cover" style="page-break-after:always;font-family:方正公文仿宋;width:100%;height:100%;border:none;margin: 0 auto;text-align:center;">
    ...
    <div style="width:60%;margin: 0 auto;height:0;padding-bottom:10%;">
        ...
        <img src="https://img.cdn1.vip/i/693fca84127d1_1765788292.webp" alt="校名" style="width:90%;"/>
    </div>
    </br></br></br></br>
    <p style="font-family:华文中宋;text-align:center;font-size:30pt;margin: 0 auto">《数值分析》实验 </p>
    </br></br></br></br></br></br></br>
    ...
    <tbody style="font-family:方正公文仿宋;font-size:15pt;">
        <tr style="font-weight:normal;"> 
            ...
            <td style="width:2%">：</td> 
            <td style="width:30%;font-weight:normal;border-bottom: 1px solid;text-align:center;font-family:华文仿宋"> 数值分析</td>     </tr>
        <tr style="font-weight:normal;"> 
        ...
        <tr style="font-weight:normal;"> 
            ...
            <td style="width:2%">：</td> 
            <td style="width:30%;font-weight:normal;border-bottom: 1px solid;text-align:center;font-family:华文仿宋">何平 </td>     </tr>
    </tbody>              
    </table>
	</br></br></br></br>
	<p style="text-align:center;font-size:17pt;margin: 0 auto;font-family:华文仿宋">2025 年 12 月 24 日 </p>                       
	</br></br></br></br>
<p style="text-align:center;font-size:13pt;margin: 0 auto;font-family:华文仿宋">所有实现代码已全部上传</br><a href="https://github.com/llTZBll/NumericalAnalysis_Lib" target="_blank">https://github.com/llTZBll/NumericalAnalysis_Lib</a></p>
</br></br>
</div>
